			...
			<div class="trade-position">
				<div class="trade1">
					...
					<div id="tr">
						...
						<c:if test="${vo.ssell==null}">
							<div class="tr1">최근 거래가 : ${vo.plprice}</div>
						</c:if>
					</div>
				</div>
					<div class="trade-button">
						...
						<c:if test="${vo.ssize==null}">
							<button id="bid" value="2">입찰구매</button>
						</c:if>
					</div>
			</div>
		</div>
		<div id="buy1">
			<form name="frm" method="post" action="insert" enctype="multipart/form-data">
				...
				<div class="buy-button">
					...
					<c:if test="${vo.ssell!=null}">
						<button type="submit" class="sbuy">즉시구매</button>
					</c:if>
					<c:if test="${vo.ssell==null}">
					<button type="submit" class="sbuy1">입찰구매</button>
					</c:if>
				</div>
			</form>
		</div>
